...
[`gs_align_call_run.provenance.yaml`](gs_align_call_run.provenance.yaml)
(JSON twin: `gs_align_call_run.provenance.json`).

It records a GS alignment + variant-calling run structured after the **W3C PROV**
...
[`../examples/genome_sequencing/`](../examples/genome_sequencing/). Each
